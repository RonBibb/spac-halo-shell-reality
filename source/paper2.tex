...
The localized structures detected by the framework satisfy nine complementary tests against artifact origin (eight artifact-channel tests plus one confounding-control demotion):
