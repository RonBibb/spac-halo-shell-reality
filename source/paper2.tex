...
\caption{\textbf{[Figure 3.1.4 --- Inner-vs-outer in two-shell galaxies]} Paired comparison of inner versus outer shell properties in the 16 two-shell galaxies of the NGC 6674-excluded canonical sample. Outer shells are systematically more massive (14/16; Wilcoxon $p = 10^{-4}$) and broader (14/16; $p = 0.0008$) than inner shells, with median outer-to-inner mass ratio 2.06 and median outer-to-inner radius ratio 2.62. The inner and outer populations occupy statistically distinct $r/r_{\rm vir}$ distributions (KS $D = 0.69$, $p = 0.0007$). \emph{Data source:} \texttt{data/antiwarp\_per\_shell.csv} filtered to two-shell galaxies (n\_total = 2).}
\end{figure}
