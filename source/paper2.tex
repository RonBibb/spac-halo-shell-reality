...
\begin{itemize}
  \item \textbf{Bulge correlation:} OR $= 3.67$, Fisher $p = 0.0095$ (one-sided; Bonferroni-fail at $\alpha = 0.05/7 = 0.0071$). Additionally entanglement-demoted by \S3.1.1's bulge--morphology contrast.
