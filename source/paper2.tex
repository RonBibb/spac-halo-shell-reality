...
\tablecaption{TODO: caption\label{tab:auto_3}}
\tablehead{
\colhead{Quantity} & \colhead{Full sample (n = 67)} & \colhead{Clean subsample (n = 25)} \\
}
\startdata
